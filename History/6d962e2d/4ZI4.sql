...
alter table pedido_usuario add constraint pedido_usuario_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);
alter table wish_list add constraint comentario_usuario_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);
alter table carrito add constraint comentario_usuario_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);
alter table pedido_usuario add constraint comentario_usuario_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);