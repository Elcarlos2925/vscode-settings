...
<div class="mensaje-error">
    ...
    <div class="Forms-Login">
        ...
        <form method="post">
            ...
            <div class="contraseña-contenedor">
                <input type="password" oninput="validarContrasena(this.value)" name="contraseña" id="contraseña" placeholder="Ingrese su Contraseña" required>
    ...
    <script>
            function validarContrasena(contrasena) {
                ...
                if (!regex.test(contrasena)) {
                    mensajeCondiciones.style.color = "red";
                } else {
                    mensajeCondiciones.style.color = "green";
                }
            }
        </script>
