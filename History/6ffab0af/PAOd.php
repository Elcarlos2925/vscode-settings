...
<body>
    <header class="header">
        ...
        <div class="botones-izq">
            ...
            <a href="index.php" class="car-shop"><button><img src="../img/carrito.png" width="auto" height="50%" alt="carrito nav-bar"><span id="numerito" class="numerito">11</span></button></a>
            </div>
        </div>
