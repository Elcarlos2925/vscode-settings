...
if(isset($_POST['finalizar_compra']))
{
    ...
    if ($mes > 12) {
        echo "Error: Los primeros dos dígitos no pueden ser mayores a 12.";
        $mensaje="<div class='contenedor-mensaje'>
                    <strong>hubo un error en el registro</strong>Los primeros dos dígitos no pueden ser mayores a 12, por favor, da click en el boton en la parte inferior izquierda y llena el campo cvv.
                    </div>";
    }
    // Verifica que los siguientes dos dígitos no sean menores a 23
    $dia = intval(substr($fecha, 3, 2));
    if ($dia < 23) {
        echo "Error: Los siguientes dos dígitos no pueden ser menores a 23.";
    }
    {
