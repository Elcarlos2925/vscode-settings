                ...
                <div class="centrar-tarjeta card" id="card-container">
                    ...
                    <div class="face front contenedor-tarjeta">
                        ...
                        <div class="contenedor-numero-tarjeta">
                            <input class="contenedor-numero-tarjeta" maxlength="19" pattern="[0-9]+" oninput="numeroTarjeta1(this.value)" type="text" finalizar_compra placeholder="0000 0000 0000 0000" required>
                        </div>
