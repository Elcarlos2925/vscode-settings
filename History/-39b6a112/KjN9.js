const productos=[
    {
        ...
        <br><strong>Cantidad: 3 piezas
        <br><strong>Tamaño (Gramaje, Volumen): 16 oz
        <br><strong>Acabado: Liso
        <br><strong>Color: Blanco
        <br><strong>Color de la goma: Café, ocre y rosa
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Sí
        <br><strong>Género: Unisex
        <br><strong>Material: Plástico resistente
        <br><strong>Medida de altura: 115.16 mm
        <br><strong>Medida de ancho: 126.28 mm
        <br><strong>Medida de peso: 0.240 kg
        <br><strong>Medida de profundidad: 101.71 mm
        <br><strong>Requiere ensamblaje: No
        <br><strong>Uso recomendado: Comedor
