const productos=[
    {
        ...
        <br><strong>Color: Café y ocre
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Sí
        <br><strong>Género: Unisex
        <br><strong>Material: Cerámica
        <br><strong>Medida de altura: 113.26 mm
        <br><strong>Medida de ancho: 121.13 mm
        <br><strong>Medida de peso: 0.362 kg
        <br><strong>Medida de profundidad: 88.26 mm
