...
function numeroTarjeta(valor) {
    ...
    // Establecer el valor formateado en el primer input
    document.getElementById('inputnumerotarjeto').value = resultado;

    // Establecer el valor formateado en el segundo input
    var segundoInput = document.getElementById('numeroTarjeta');
    segundoInput.value = resultado;
}