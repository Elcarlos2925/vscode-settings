const productos=[
    {
      ...
      },
      {
        ...
        "imagen": "./img/P1.png", 
        "precio": 99.00,
        "imagen1": "./img/11-1.png",
        "imagen2": "./img/11-2.png",
        "imagen3": "./img/11-3.png",
        "Descripción": `<h2>Descripción<h2>
        <br>Lleva contigo tu pasión por el café a todas partes con nuestro encantador Llavero taza de café The Drop Coffee. Este llavero es mucho más que una simple pieza, es una declaración de tu amor por el café y tu afinidad con The Drop Coffee.
  
        <br>El llavero está hecho de metal resistente y tiene una forma única: un vaso de café estilizado, que mide 6x4 cm (centímetros). Además, viene acompañado de un grano de café por separado, un símbolo del ingrediente esencial que da vida a tus bebidas favoritas.
        ...
        <br>Género: Unisex
        <br>Material: metal
        <br>Medida de altura: 6 cm
        <br>Medida de ancho: 4 cm
        <br>Medida de peso: 0.52 kg
        <br>Requiere ensamblaje: No
        <br>Uso recomendado: Llaves, mochila o bolso
        `,
        "Instrucciones de uso": `<h2>Instrucciones de uso<h2>
      ...
      },
      {
        ...
        "imagen2": "./img/14-2.png",
        "imagen3": "./img/14-3.png",
        "precio": 350.00,
        "Descripción": `<h2>Descripción<h2>
        <br>La Sudadera Ocre Especial The Drop Coffee es mucho más que una prenda, es una declaración de estilo y pasión por el café. Esta sudadera de un hermoso tono ocre te permite llevar contigo la esencia de The Drop Coffee en cada paso que das.
      ...
      },
      {
        ...
        "imagen2": "./img/15-2.png",
        "imagen3": "./img/15-3.png",
        "precio": 350.00,
        "Descripción": `<h2>Descripción<h2>
        <br>La Sudadera Café Especial The Drop Coffee es mucho más que una prenda, es una declaración de estilo y pasión por el café. Esta sudadera de un hermoso tono café te permite llevar contigo la esencia de The Drop Coffee en cada paso que das.
