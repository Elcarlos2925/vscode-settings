const productos=[
    {
        ...
        <br><strong>Tamaño (Talla): A su elección (CH, M, G, EG)
        <br><strong>Acabado: Liso
        <br><strong>Color: Café
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Sí
        <br><strong>Género: Unisex
        <br><strong>Material: 100% algodón
        <br><strong>Medida de altura: Varía según la talla seleccionada
        <br><strong>Medida de ancho: Varía según la talla seleccionada
        <br><strong>Medida de peso: Peso ligero y cómodo
        <br><strong>Medida de profundidad: Estándar para una sudadera
        <br><strong>Requiere ensamblaje: No
        <br><strong>Uso recomendado: Uso diario, ocasiones casuales
        <br><strong>Forma: Corte clásico, diseño tradicional
        `,
