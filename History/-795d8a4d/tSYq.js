const productos=[
    {
        ...
        <h2>Instrucciones</h2>
       so 4. Prueba tu café. ¿No tiene la fuerza deseada? Añade más gránulos de café la próxima vez. ¿Demasiado fuerte? Reduce la cantidad de café y añade un poco más de leche. Ajusta según sean tus preferencias.
       `
    }
]
...
function mostrarIngredientes() {
    ...
    /*let mensaje;
    productos.forEach(producto => {
        mensaje = producto.Ingredientes;
    })
    var mensajeCondiciones = document.getElementById("contenido");
