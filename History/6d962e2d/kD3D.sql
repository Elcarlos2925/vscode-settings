...
alter table pago_usuario add constraint pago_usuario_id_pago_fk foreign key (id_pago) references pago(id_pago);
alter table pago_usuario add constraint pago_usuario_id_usuario_fk foreign key (id_usuario) references usuarios(id_usuario);
