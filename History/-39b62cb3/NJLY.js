const productos=[
    {
        ...
        <br><strong>Tamaño (Gramaje, Volumen): 500 ml
        <br><strong>Acabado: Liso
        <br><strong>Color: transparente
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Si
        <br><strong>Género: Unisex
        <br><strong>Material: plástico resistente
        <br><strong>Medida de altura: 120.63 mm
        <br><strong>Medida de ancho: 136.72 mm
        <br><strong>Medida de peso: 0.136 kg
        <br><strong>Medida de profundidad: 107.64 mm
