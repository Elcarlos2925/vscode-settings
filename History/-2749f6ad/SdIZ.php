...
if(isset($_POST['guardar-direccion']))
{
    ...
    >= 1)
    {
        ...
        $consulta="INSERT INTO `direccion`(`codigo_postal`, `ciudad`, `estado`, `calle`, `entre_calle`, `especificaciones`, `num_int`, `num_ext`, `id_direccion`, `nombre_receptor`, `tel`, `id_usuario`) VALUES ('$CP','$municipio]','$estado','$calle','$entre_calles','$especificaciones','$num_int','$num_ext','1','$nombre','$telefono','2');";
