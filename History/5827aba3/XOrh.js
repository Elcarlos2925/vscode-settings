const productos=[
...

    {
        ...
        "Descripción": `
        Descripción
        <br>Sumérgete en el mundo del café poblano con nuestro Café de Puebla, una verdadera joya tostada con mucho cariño en esta hermosa región.  Este café de especialidad poblano es el fruto de la pasión y dedicación que los amantes del café han vertido en su creación. Hemos elegido granos 100% arábigo para ofrecer una experiencia única, con un tostado medio que resalta sus sabores naturales.
        <br>
        <br>Este café te lleva directo a la tierra y la cultura de Puebla. Aprovecha la oportunidad de disfrutar de una taza única de México en cualquier momento del día. ¡Consigue tu bolsa de Café de Puebla hoy y lleva a tu casa el auténtico sabor de esta tierra rica en tradición.
        <br>
        <br>Contenido neto: 300 g (gramos)
        <br>Intensidad: 6
        <br>Tostado: Medio
        ...
        "Ingredientes": `
        Ingredientes
        <br>Café de especialidad poblano tostado medio y molido 100% arábigo.
        `,
        "Instrucciones de uso": `
        Instrucciones
        <br>
...

    {
        ...
        "precio": 250.00,
        "Descripción": `Descripción
        <br>Sumérgete en el mundo del café poblano con nuestro Café de Puebla Descafeinado, una auténtica joya tostada con cariño en esta hermosa región. Este café especial de poblano es el resultado de la pasión y el esfuerzo dedicado por los amantes del café en su creación. Hemos seleccionado granos 100% arábigo para brindar una experiencia única, con un tostado medio que realza sus sabores naturales.
        <br>
        <br>Este café te transporta directamente a la tierra y la cultura de Puebla. Aprovecha la oportunidad de saborear una taza única de México en cualquier momento del día. ¡Obtén tu bolsa de Café de Puebla Descafeinado hoy y lleva a tu hogar el auténtico sabor de esta tierra rica en tradición.
        <br>
        <br>Contenido neto: 300 g (gramos)
        <br>Intensidad: 6
        <br>Tostado: Medio
        ...
        `, 
        "Ingredientes": `Ingredientes
        <br>Café descafeinado  de especialidad poblano tostado medio y molido 100% arábigo.
        `,
        "Instrucciones de uso": `
        Instrucciones
        <br>
...

    {
        ...
        "precio": 250.00,
        "Descripción": `Descripción
        <br>Adéntrate en el mundo del café chiapaneco con nuestro Café de Chiapas Descafeinado, una auténtica joya tostada con cariño en esta hermosa región. Este café especial de Chiapas es el resultado de la pasión y el esfuerzo dedicado por los amantes del café en su creación, ahora sin cafeína. Hemos seleccionado granos 100% arábigo para brindar una experiencia única, con un tostado medio que realza sus sabores naturales.
        <br>
        <br>Este café te transporta directamente a la tierra y la cultura de Chiapas, pero sin la cafeína. Aprovecha la oportunidad de saborear una taza única de México en cualquier momento del día. ¡Obtén tu bolsa de Café de Chiapas Descafeinado hoy y lleva a tu hogar el auténtico sabor de esta tierra rica en tradición.
        <br>
        <br>Contenido neto: 300 g (gramos)
        <br>Intensidad: 6
        <br>Tostado: Medio
        ...
        `, 
        "Ingredientes": `Ingredientes
        <br>Café descafeinado de especialidad chiapaneco tostado medio y molido 100% arábigo.
        `,
        "Instrucciones de uso": `
        Instrucciones
        <br>
...

    {
        ...
        "precio": 250.00,
        "Descripción": `Descripción
        <br>Embárcate en un emocionante viaje a través de nuestro Café de Mezclas Mexicanas Descafeinado, una fusión única que proviene de las ricas tierras de Veracruz, Chiapas, Puebla y Oaxaca. Este café especial sin cafeína es el resultado de la pasión y dedicación de los amantes del café en estas cuatro hermosas regiones. Hemos seleccionado granos 100% arábica de estos lugares para brindar una experiencia excepcional, con un tostado medio que realza sus sabores naturales.
        <br>
        <br>Este café te sumerge en la diversidad de las tierras y las culturas de Veracruz, Chiapas, Puebla y Oaxaca, pero sin la cafeína. Aprovecha la oportunidad de saborear una taza única de México que combina lo mejor de estas regiones en cualquier momento del día. ¡Obtén tu bolsa de Café de Mezclas Mexicanas Descafeinado hoy y lleva a tu hogar el auténtico sabor de estas tierras ricas en tradición.
        <br>
        <br>Contenido neto: 300 g (gramos)
        <br>Intensidad: 6
        <br>Tostado: Medio
        ...
        `, 
        "Ingredientes": `Ingredientes
        <br>Café descafeinado de especialidad mezclas mexicanas tostado medio y molido 100% arábigo.
        `,
        "Instrucciones de uso": `
        Instrucciones
        <br>
...

    {
        ...
        "precio": 250.00,
        "Descripción": `Descripción
        Descubre el apasionante mundo del café sin cafeína con nuestra versión descafeinada del Café Especial The Drop Coffee. Este café es el corazón de nuestra casa, una creación única que te ofrece una experiencia de café excepcional sin la cafeína.
        Cada taza de Café Especial The Drop Coffee Descafeinado es una aventura de sabores, con detalles únicos que te transportan a lugares lejanos. Hemos seleccionado los granos más finos y excepcionales para brindarte un sabor verdaderamente distintivo, incluso sin cafeína.
        
        
        Nuestro café descafeinado está tostado a la perfección para resaltar su carácter especial, ofreciendo un equilibrio entre intensidad y suavidad que te encantará en cada sorbo. Es más que una bebida, es una expresión de nuestra pasión por el café de calidad, ahora sin cafeína.
        
        Disfruta de una taza de "The Drop Coffee" Descafeinado en cualquier momento del día y descubre por qué es un verdadero café especial de la casa, sin la cafeína.
        
        Contenido neto: 300 g (gramos)
        Intensidad: 6
        Tostado: Medio
        Aroma: Intenso
        Intensidad: Ligera
