...
alter table wish_list add constraint wish_list_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);
...
alter table direccion_usuario add constraint direccion_usuario_id_comentario_fk foreign key (id_comentario) references comentario(id_comentario);