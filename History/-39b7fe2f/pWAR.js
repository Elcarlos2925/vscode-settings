const productos=[
    {
        ...
        <br><strong>Cantidad: 2 tazas
        <br><strong>Tamaño (Gramaje, Volumen): 16 oz
        <br><strong>Acabado: Liso
        <br><strong>Color: Café y ocre obscuros
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Sí
        <br><strong>Género: Unisex
        <br><strong>Material: Plástico resistente
        <br><strong>Medida de altura: 115.26 mm
        <br><strong>Medida de ancho: 125.13 mm
        <br><strong>Medida de peso: 0.380 kg
        <br><strong>Medida de profundidad: 90.26 mm
