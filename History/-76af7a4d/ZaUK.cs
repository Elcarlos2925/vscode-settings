            ...
            do
            {
                try
                {
                    ...
                    else if (opc == 3) //captura datos
                    {
                        ...
                        Console.Clear();//limpiar pantalla
                        Prs.Imprime();//imprime metodo
                    }
                }//desplegar excepsiones
                ...
                Console.ReadKey();//Bloquear impresión
                Console.Clear();//limpiar pantalla y desplegar menú do while
...
namespace P8.PolClAbs_Autos
{
    internal class Personales:Autos
    {
        ...
        public override void Imprime()
        {
            base.ImprimeDatos();//imprimir datos
