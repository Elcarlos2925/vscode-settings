...
let linkVista = document.querySelectorAll(".imagenCafe");
    ...
    productos.forEach(producto => {
        ...
        <div class="contenedor_producto">
            <div class="imagen-cafe">
                <a <!--href="Productos/index.php"--> class="imagenCafe" id="${producto.id}" ><img src="${producto.imagen}"></a>
            </div>
...
function actualizarIdVista(){
    linkVista = document.querySelectorAll(".imagenCafe");
    console.log(linkVista);

    linkVista.forEach(boton => {
