const productos=[
    {
        ...
        <br><strong>Cantidad: 1 pieza
        <br><strong>Acabado: Liso
        <br><strong>Color: Café y gris
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Si
        <br><strong>Género: Unisex
        <br><strong>Material: metal
        <br><strong>Medida de altura: 6 cm
        <br><strong>Medida de ancho: 4 cm
        <br><strong>Medida de peso: 0.52 kg
        <br><strong>Requiere ensamblaje: No
        <br><strong>Uso recomendado: Llaves, mochila o bolso
        `,
