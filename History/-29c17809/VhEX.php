    ...
    <div class="productos">
        ...
        <div class="fondo-contenedor">
            <div class="contenedor_producto">
                ...
                <div class="descripcion-producto">
                    <p style="color:#EBE6DF" id="nombre-cafe">Café de Veracruz Descafeinado 300g</p>
                    <div class="precio-boton">
                        <p id="precio">$250.00</p>
                        <button class="añadir-al-carrito"><img src="img/carrito+.png" id="carritoplus" /></button>
                    </div>
        ...
        <div class="fondo-contenedor">
            <div class="contenedor_producto">
                ...
                <div class="descripcion-producto">
                    <p style="color:#EBE6DF" id="nombre-cafe">Café Americano de 250g</p>
                    <div class="precio-boton">
                        <p id="precio">$250.00</p>
                        <button class="añadir-al-carrito"><img src="img/carrito+.png" id="carritoplus" /></button>
                    </div>
        ...
        <div class="fondo-contenedor">
            <div class="contenedor_producto">
                ...
                <div class="descripcion-producto">
                    <div style="color:#EBE6DF" id="nombre-cafe">Café Americano de 250g</div>
                    <div class="precio-boton">
                        <p id="precio">$250.00</p>
                        <button class="añadir-al-carrito"><img src="img/carrito+.png" id="carritoplus" /></button>
                    </div>
