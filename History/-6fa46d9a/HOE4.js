...
let Vista = document.querySelectorAll(".añadir-al-carrito");
    ...
    productos.forEach(producto => {
        ...
        <div class="contenedor_producto">
            <div class="imagen-cafe" id="${producto.id}">
                <a href="#" id="Productos/index.php" ><img class="imagen-cafe" src="${producto.imagen}"></a>
            </div>
...
function actualizarIdVista(){
    Vista = document.querySelectorAll(".añadir-al-carrito");
    console.log(Vista);
