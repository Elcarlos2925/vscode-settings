const productos=[
    {
        ...
        <br><strong>Color: ocre y amarillo
        <br><strong>Es industrial: No
        <br><strong>Es portátil: Si
        <br><strong>Género: Unisex
        <br><strong>Material: metal y plástico
        <br><strong>Medida de altura: 10 cm
        <br><strong>Medida de ancho: 8 cm
        <br><strong>Medida de peso: 0.83 kg
